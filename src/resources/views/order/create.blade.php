    ...
    <div class="relative overflow-x-auto py-12">
        ...
        <form method="post" action="{{ route('orders.store') }}" class="max-w-md mx-auto">
            ...
            <div class="mb-5">
                ...
                <input name="name" type="text" id="name" value="ФИО" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ФИО" required />
            </div>
            <div class="mb-5">
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Номер телефона
                </label>
                <input name="phone" type="text" value="89513960877" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Телефон" required />
            ...
            <div class="mb-5">
                ...
                @if($errors->first('lastDate'))
                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                        <span class="font-medium">
                            {{ $errors->first('lastDate') }}
                        </span>
                    </div>
                @endif
            </div>
